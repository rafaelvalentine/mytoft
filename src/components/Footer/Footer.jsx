        ...
        <div className='footer-links'>
          <div className='footer-links-content'>
            <div className='footer-links-text'>
              <p><strong>TOFT TECHNOLOGY</strong> offers the best services in technology to take your business to the next leve.Our areas of focus include Software Assets Management, Microsoft Licensing Advisory, Business Process Automation, and Custom Applications development. </p>
            </div>
            <div>
              ...
              <ul className='list-two'>
                ...
                <li><a href='mailto:info@torftechnologies.com'> <span onMouseOver={this.changeImage} onMouseOut={this.changeImageBack} style={{ backgroundImage: 'url("assets/img/mail(1).svg")' }} id='mail' className='mail'>  </span> </a></li>
                <li><a href='tel:+234 810 394 3909 '> <span onMouseOver={this.changeImage} onMouseOut={this.changeImageBack} style={{ backgroundImage: 'url("assets/img/phone(1).svg")' }} id='phone' className='phone' /></a></li>
              </ul>
            </div>
          </div>
